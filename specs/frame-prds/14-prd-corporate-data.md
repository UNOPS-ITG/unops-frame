...
4. Whether corporate figures should be offered at all before a pilot register asks for one by name. The dimension half carries the durable value; a figure column is an excellent demonstration and a standing cost. Proposal: hold at P3 and ship only where a grain-level mart already exists.
