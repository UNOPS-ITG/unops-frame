...
// Node CLI
// Vendored from the `dataviz` skill. Renamed to .mjs to match this repo's
// script convention (package.json is not type:module, so a bare .js file
// carrying `export` would not parse) — hence the widened entry guard below.
